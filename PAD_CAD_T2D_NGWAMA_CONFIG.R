########## Configuration File for PAD CAD T2D scan
...
Pathtrait3="/project/voight_GWAS/wbone/CHD_T2D_2020_bivariate_scan/T2D_Vujkovic_et_al_dbSNP150_onlySNPs_data.txt"
...
trait3_BPcol = "POS"
trait3_CHRcol = "CHR"
trait3_SAMPLESIZEcol = 1407282



### For each trait, add a trait lable to the traits data frame
traits <- as.data.frame(c("PAD","CAD","T2D"))
