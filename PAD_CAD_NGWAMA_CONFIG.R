########## Configuration File for PAD CAD scan
...
traits <- as.data.frame(c("PAD","CAD"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Heart Disease","Coronary","Artery disease"))
