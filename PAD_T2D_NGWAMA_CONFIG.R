...
Pathtrait2="/project/voight_GWAS/wbone/CHD_T2D_2020_bivariate_scan/T2D_Vujkovic_et_al_dbSNP150_onlySNPs_data.txt"
...
trait2_BPcol = "POS"
trait2_CHRcol = "CHR"
trait2_SAMPLESIZEcol = 1407282



### For each trait, add a trait lable to the traits data frame
traits <- as.data.frame(c("PAD","T2D"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("T2D","type II diabetes","Type 2 diabetes","type ii diabetes"))
