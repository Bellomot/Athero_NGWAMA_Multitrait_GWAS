########## Configuration File for PAD CAD SMK scan, SMK is space seperated
...
Pathtrait3="/project/voight_GWAS/wbone/NGWAMA/SMK_GWAS_UKBB/2019.10.02_Lifetime_Smoking_GWAS_Data_Sheet_1.txt"

trait3_SNPcol = "SNP"
trait3_EAcol = "EFFECT_ALLELE"
...
trait3_BPcol = "BP"
trait3_CHRcol = "CHR"
trait3_SAMPLESIZEcol = 462690



### For each trait, add a trait lable to the traits data frame
traits <- as.data.frame(c("PAD","CAD","SMK"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Heart Disease","Coronary","Artery disease"), c("Smoke", "Smoking"))
