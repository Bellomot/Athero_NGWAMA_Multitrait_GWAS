########## Configuration File for PAD TG scan
...
Pathtrait2="less -S /project/voight_GWAS/wbone/NGWAMA/TG_remeta_data_with_MAF_Clean.txt"
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Triglycerides","TG","triacylglycerol","triacylglyceride"))
