########## Configuration File for PAD CAD LDL scan
...
Pathtrait3="/project/voight_GWAS/wbone/NGWAMA/LDL_remeta_data_with_MAF_Clean.txt"
...
traits <- as.data.frame(c("PAD","CAD","LDL"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Heart Disease","Coronary","Artery disease"), c("LDL","Low-density lipoprotein","low density"))
