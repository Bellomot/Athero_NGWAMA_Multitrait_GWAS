########## Configuration File for PAD BMI scan
...
Pathtrait2="/project/voight_GWAS/wbone/PAD_and_CAD_Bivariate_scan/BMI_Pulit_data_rsID_ready.txt"

trait2_SNPcol = "SNP"
trait2_EAcol = "Tested_Allele"
trait2_OAcol = "Other_Allele"
trait2_EAFcol = "Freq_Tested_Allele"
trait2_SEcol = "SE"
trait2_PVALcol = "P"
trait2_BETAcol = "BETA"
trait2_BPcol = "POS"
trait2_CHRcol = "CHR"
trait2_SAMPLESIZEcol = 806834



### For each trait, add a trait lable to the traits data frame
traits <- as.data.frame(c("PAD","BMI"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Body mass index","Body mass"))
