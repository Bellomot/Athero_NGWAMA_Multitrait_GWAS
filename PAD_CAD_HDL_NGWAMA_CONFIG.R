########## Configuration File for PAD CAD HDL scan
...
Pathtrait3="/project/voight_GWAS/wbone/NGWAMA/HDL_remeta_data_with_MAF_Clean.txt"
...
traits <- as.data.frame(c("PAD","CAD","HDL"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Heart Disease","Coronary","Artery disease"), c("HDL","High-density lipoprotein","high density"))
