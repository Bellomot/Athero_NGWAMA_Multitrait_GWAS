########## Configuration File for PAD T2D scan
...
Pathtrait3="/project/voight_GWAS/wbone/PAD_and_CAD_Bivariate_scan/BMI_Pulit_data_rsID_ready.txt"

trait3_SNPcol = "SNP"
trait3_EAcol = "Tested_Allele"
trait3_OAcol = "Other_Allele"
trait3_EAFcol = "Freq_Tested_Allele"
trait3_SEcol = "SE"
trait3_PVALcol = "P" 
trait3_BETAcol = "BETA"
trait3_BPcol = "POS"
trait3_CHRcol = "CHR"
trait3_SAMPLESIZEcol = 806834


### For each trait, add a trait lable to the traits data frame
traits <- as.data.frame(c("PAD","CAD","BMI"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Heart Disease","Coronary","Artery disease"), c("Body mass index","Body mass"))
