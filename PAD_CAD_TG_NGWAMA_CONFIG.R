########## Configuration File for PAD CAD TG scan
...
Pathtrait3="/project/voight_GWAS/wbone/NGWAMA/TG_remeta_data_with_MAF_Clean.txt"
...
traits <- as.data.frame(c("PAD","CAD","TG"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Heart Disease","Coronary","Artery disease"), c("Triglycerides","TG","triacylglycerol","triacylglyceride"))
