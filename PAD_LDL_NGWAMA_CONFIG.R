########## Configuration File for PAD LDL scan
...
Pathtrait2="/project/voight_GWAS/wbone/NGWAMA/LDL_remeta_data_with_MAF_Clean.txt"
...
traits <- as.data.frame(c("PAD","LDL"))
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("LDL","Low-density lipoprotein","low density"))
