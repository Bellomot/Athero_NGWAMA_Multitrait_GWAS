########## Configuration File for PAD TC scan
...
Pathtrait2="/project/voight_GWAS/wbone/NGWAMA/TC_remeta_data_with_MAF_Clean.txt"
...
strListTrait_total <- c(c("Peripheral artery", "Artery disease"), c("Cholesterol","Total cho","LDL","HDL"))
